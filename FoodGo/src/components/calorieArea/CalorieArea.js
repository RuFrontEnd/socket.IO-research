...
import 'components/calorieArea/calorieArea.scss';
import DetailedInfo from 'components/detailedInfo/DetailedInfo';
import DetailedInfoTotal from 'components/detailedInfoTotal/DetailedInfoTotal';

function CalorieArea(props) {
  const {
    data,
    riceName,
    riceCal,
      ...
      <div className="ru-info-item-container">
        ...
        <ul className="ru-info-item-warp">
          ...
          >
            ...
            {isShowDetailedInfo1 && (
              <DetailedInfo data={data} riceName={riceName} />
            )}
          </li>
          {/* 詳細資料品項1 e */}
          ...
          >
            ...
            {isShowDetailedInfo2 && (
              <DetailedInfo data={data} meetName={meetName} />
            )}
          </li>
          {/* 詳細資料品項2 e */}
          ...
          >
            ...
            {isShowDetailedInfo3 && (
              <DetailedInfo data={data} vegNameA={vegNameA} />
            )}
          </li>
          {/* 詳細資料品項3 e */}
          ...
          >
            ...
            {isShowDetailedInfo4 && (
              <DetailedInfo data={data} vegNameB={vegNameB} />
            )}
          </li>
          {/* 詳細資料品項4 e */}
          ...
          >
            ...
            {isShowDetailedInfo5 && (
              <DetailedInfo data={data} vegNameC={vegNameC} />
            )}
          </li>
          {/* 詳細資料品項5 e */}
          ...
          >
            ...
            {isShowDetailedInfo6 && (
              <DetailedInfo data={data} eggName={eggName} />
            )}
          </li>
          {/* 詳細資料品項 e */}
        </ul>
